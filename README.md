...
- El **DATO** es un registro o anotación de un evento u ocurrencia. Un banco de
  datos, por ejemplo, es un medio para acumular y almacenar conjuntos de datos
  para que sean posteriormente combinados y procesados. Cuando un conjunto de
  datos posee un significado, tenemos una información.
